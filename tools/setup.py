...
def main():
    ...
    print("""
  ######################################
  # WFAR Development Environment Setup #
  ######################################

  This script will create your WFAR dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your WFAR project folder:
    [Arma 3 installation directory]\\{} => WFAR project folder
    P:\\{}                              => WFAR project folder
