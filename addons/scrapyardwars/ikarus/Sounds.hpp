		...
		insideSoundCoef = 0.9;
		soundGear[]={"",db-85,1};
		soundGetIn[]={"z\wfar\addons\scrapyardwars\ikarus\sounds\ext-bus-getout-1",db-0,1};
		soundGetOut[]={"z\wfar\addons\scrapyardwars\ikarus\sounds\int-bus-getout-1",db-0,1, 40};
