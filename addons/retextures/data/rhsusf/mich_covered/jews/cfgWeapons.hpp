class wfar_jews_mich_helmet_marpatwd: rhsusf_mich_helmet_marpatwd
{
    ...
    {
        QUOTE(z\wfar\addons\retextures\data\rhsusf\mich_covered\jews\standard\mich_covered_rhino_wd_co.paa),
...
class wfar_jews_mich_helmet_marpatd: wfar_jews_mich_helmet_marpatwd
{
    ...
    hiddenSelectionsTextures[]=
    {
        QUOTE(z\wfar\addons\retextures\data\rhsusf\mich_covered\jews\standard\mich_covered_rhino_des_co.paa),
        "rhsusf\addons\rhsusf_infantry\gear\head\data\ach_acc_tan_co.paa"
    };
};
